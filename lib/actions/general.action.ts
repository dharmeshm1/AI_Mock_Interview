    ...
    try {
        ...
        const { object } = await generateObject({
            model: google("gemini-2.0-flash-001", {
                structuredOutputs: true, // ✅ must be true when using schema
            }),
        ...
        Return the results strictly in the schema format.`,
            system:
                "You are a professional interviewer analyzing a mock interview. Return structured JSON only, no extra text.",
        });
        ...
        const feedback = {
            ...
            categoryScores: object.categoryScores, // now array of objects
